...
#################### TA NOTES ###########################################
# Rubric: 2pts per question, total of 42 questions.

#Graded by Camille (camille.arteau-leclerc.1@ulaval.ca)

# For 1H, don't forget to add ordered = TRUE inside your parentheses.

# For 2G, your output is correct, but here's another way to do it by using the filter() function:
# data1 %>%
...
# #For the 'Spectre' and 'Skyfall' puzzle, there are many ways to do it, but here's two of them:
# movies[c(str_which(movies$movie_title, "Spectre"):str_which(movies$movie_title, "Skyfall")),]
# OR
# movies %>%
#   slice(str_which(movie_title, "Spectre"):str_which(movie_title, "Skyfall")) 
# 
# In both cases, you need the str_which function. 
# -2pts

# The WIID 2020 dataset was available on Canvas. Please, for the future assignments always use the datasets 
# available on Canvas.
# Because you didn't use the WIID 2020 dataset, you didn't do 3B
# -2pts

# 78/84

#Good job! Come to my office hours if you have any questions!
...
movie <- read.csv("/Users/camillearteau-leclerc/Dropbox/Data_Visualization/movie_metadata.csv", stringsAsFactors = FALSE)
...
### TA comment: please use the datasets that are available on Canvas. 
